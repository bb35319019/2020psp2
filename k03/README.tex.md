...
- 時間がないのでOKですが，次のことを行って自分でこのレポートを完成させてください．
- 入出力結果には，2種類の結果を書きます．
  - 1つ目は，`gcc -o k03 k03.c`で作られた実行ファイル k03 を使って，`./k03 170.8 5.43 5`で出力された結果
  - 2つ目は，`gcc -o k03_const k03.c -DCONST_SEED`で作られた実行ファイル k03_const を使って `./k03_const 170.8 5.43 5`で出力された結果
